        ...
        <div class="col-lg-4 col-md-5 col-sm-6 col-xs-7 mb-5">
          ...
          <div class="card rounded">
            <ul class="nav nav-tabs justify-content-center bg-light" style="padding: 20px;">
              ...
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#receivers">User's</a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane container fade" id="admin">
                <form action="file/adminlogin.php" method="post">
                  <label class="text-muted font-weight-bold" class="text-muted font-weight-bold">Admin Email</label>
                  <input type="email" name="aemail" placeholder="Admin Email" class="form-control mb-4">
